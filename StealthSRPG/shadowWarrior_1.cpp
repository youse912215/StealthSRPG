...
void ShadowWarrior_1::Update(const int& se) {
	get_latency();
	wait_motion();
...
/// </summary>
void ShadowWarrior_1::Pickup(const int& se) {
...
/// キャラクターの重複判定
/// </summary>
void ShadowWarrior_1::duplicate_decision(const int& other_x, const int& other_y, const int& name) {
