...
void EnemyWolf_1::drawing_effect2() {
	if (attack_activity) {
...
void EnemyWolf_1::get_each_node() {
...
void EnemyWolf_1::get_survival_activity(const bool& p_s_activity, const bool& sw1_s_activity,
...
void EnemyWolf_1::get_two_point_distance(const int& p_x, const int& p_y, const int& sw1_x, const int& sw1_y,
                                         const int& sw2_x,
...
void EnemyWolf_1::get_minimum_husteric() {
...
void EnemyWolf_1::get_node_husteric() {
...
void EnemyWolf_1::get_obstacle_cost(vector<vector<int>>& map) {
	/* 左側のコスト */
...
void EnemyWolf_1::get_relative_position_cost() {
	/* x方向の相対位置コスト */
...
void EnemyWolf_1::get_node_cost() {
	cost[LEFT] = abs(
...
void EnemyWolf_1::get_node_score() {
...
void EnemyWolf_1::moving_decision() {
...
void EnemyWolf_1::Attack(int* p_hp, int* sw1_hp, int* sw2_hp, int* sw3_hp, const int& a_order, const int& se1,
	...
	else if (Map::turn_timer >= 10 && this->range == 0 && Map::scene == NIGHT_ENEMY) forward_act_order(a_order);
}
...
void EnemyWolf_1::get_enemy_cost_2(const int& ex1, const int& ey1, const int& ex2, const int& ey2, const int& ex3,
                                   const int& ey3, const int& ex4, const int& ey4, const int& ex5, const int& ey5,
                                   const int& ex6, const int& ey6, const int& ex7, const int& ey7, const int& ex8,
...
void EnemyWolf_1::score_decision() {
	if (minimum_score == 1) {
		this->activity = true;
...
void EnemyWolf_1::moving_end() {
	if (this->range == moving_distance) {
		this->activity = true;
	}
}

void EnemyWolf_1::activate_reset() {
	if (Map::scene % 2 == 0) {
		this->activity = false;
		attack_activity = false;
...
void EnemyWolf_1::duplicate_process(const int& dir_num) {
	enemy_cost[dir_num] = 2;
}

void EnemyWolf_1::get_attack_direction(const int& player_num) {
...
void EnemyWolf_1::get_impact_motion(const int& a_activity, int* motion) {
